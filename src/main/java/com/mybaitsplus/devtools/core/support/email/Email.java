...
public class Email implements Serializable {
	...
	private Map<String,InputStream> streamAffix;
	...
	public Map<String, InputStream> getStreamAffix() {
		return streamAffix;
	}

	public void setStreamAffix(Map<String, InputStream> streamAffix) {
		this.streamAffix = streamAffix;
	}
}
