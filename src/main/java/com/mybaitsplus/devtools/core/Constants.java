package com.mybaitsplus.devtools.core;
...
public class Constants {
    ...
    /** 缓存命名空间 */
    public static final String CACHE_NAMESPACE= PropertiesUtil2.getString("cache.namespace", PropertiesUtil2.getString("spring.application.name"))+":" ;
    /** 在线用户数量 */
