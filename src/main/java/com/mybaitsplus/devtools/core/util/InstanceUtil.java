...
import com.mybaitsplus.devtools.core.exception.DataParseException;
import com.mybaitsplus.devtools.core.exception.InstanceException;
...
public final class InstanceUtil {
	...
	public static final <K> K getBean(Class<K> cls) {
		return BeanFactoryUtil.getBean(cls);
	}
